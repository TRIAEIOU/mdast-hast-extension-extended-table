export { table as extendedTableToHast } from "./mdast-util-to-hast-lib-handlers-table";
export { table as extendedTable } from "./hast-util-to-mdast-lib-handlers-table";
