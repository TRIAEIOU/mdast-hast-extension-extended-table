 ...
 * @typedef {import('hast-util-to-mdast/lib').Element} Element
 * @typedef {import('hast-util-to-mdast/lib').MdastNode} MdastNode
 * @typedef {import('hast-util-to-mdast/lib/handlers/table').MdastTableContent} MdastTableContent
 * @typedef {import('hast-util-to-mdast/lib/handlers/table').MdastRowContent} MdastRowContent
 * @typedef {import('hast-util-to-mdast/lib/handlers/table').MdastPhrasingContent} MdastPhrasingContent
 *
 * @typedef Info
    ...
    while (++rowIndex < rows.length) {
        ...
        while (++cellIndex < cells.length) {
            ...
            if (cell.data) {
                ...
                if ('colSpan' in cell.data)
                    delete cell.data.colSpan;
                if ('rowSpan' in cell.data)
                    delete cell.data.rowSpan;
